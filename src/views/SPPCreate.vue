    ...
    <q-card class="bg-white">
      ...
      <q-card-section horizontal class="q-pa-none">
        ...
        <q-card-section class="bg-blue-grey-1 q-pa-none">
          <q-card-section class="text-h6 bg-blue-grey-5 text-white">Petunjuk Pengisian</q-card-section>
          <q-list separator>
            <q-item>
              <q-item-section>
            ...
            <q-item>
              <q-item-section>
                ...
                <q-item-label
                  caption
                >isi dengan bilangan bulat tanpa titik atau koma, misal: 1000000</q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
                ...
                <q-item-label
                  caption
                >isi secara manual misal: kg, liter, ml, box, dus, buah, rim, dll</q-item-label>
              </q-item-section>
            </q-item>
            <q-item>
              <q-item-section>
            ...
            <div class="row">
              ...
              >
                <template v-slot:label>
                  1. Nama Barang
                  <a class="q-px-sm bg-info text-white rounded-borders">input baru</a>
                </template>
              </q-input>
              <q-select
                v-else
            ...
            <div>
              <div class="row q-col-gutter-sm">
                ...
                <q-input class="col-5" outlined v-model="spp.unit" label stack-label dense>
                  <template v-slot:label>
                    3. Satuan
                    <a class="q-px-sm bg-info text-white rounded-borders">kg / m / dus</a>
                  </template>
                </q-input>
              </div>
            </div>
